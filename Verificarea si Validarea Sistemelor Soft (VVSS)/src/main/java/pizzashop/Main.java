...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) throws Exception{
        ...
        MenuRepository repoMenu=new MenuRepository(Optional.empty());
        ...
        primaryStage.setOnCloseRequest(new EventHandler<WindowEvent>() {
            ...
            public void handle(WindowEvent event) {
                ...
                if (result.get() == ButtonType.YES){
                    ...
                    System.out.println("Incasari cash: "+service.getTotalAmount(PaymentType.Cash, service.getPayments()));
                    System.out.println("Incasari card: "+service.getTotalAmount(PaymentType.Card, service.getPayments()));
