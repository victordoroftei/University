...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_PARD = 4,                       /* PARD  */
  YYSYMBOL_PARI = 5,                       /* PARI  */
  YYSYMBOL_ACD = 6,                        /* ACD  */
  YYSYMBOL_ACI = 7,                        /* ACI  */
  YYSYMBOL_SEMICOL = 8,                    /* SEMICOL  */
  ...
  YYSYMBOL_bloc_instr = 28,                /* bloc_instr  */
  YYSYMBOL_instr = 29,                     /* instr  */
  YYSYMBOL_instr_decl = 30,                /* instr_decl  */
  YYSYMBOL_tip = 31,                       /* tip  */
  YYSYMBOL_lista_var = 32,                 /* lista_var  */
  YYSYMBOL_expr = 33,                      /* expr  */
  YYSYMBOL_termen = 34,                    /* termen  */
  YYSYMBOL_op_aritmetic = 35,              /* op_aritmetic  */
  YYSYMBOL_instr_attr = 36,                /* instr_attr  */
  YYSYMBOL_instr_io = 37,                  /* instr_io  */
  YYSYMBOL_instr_input = 38,               /* instr_input  */
  YYSYMBOL_instr_output = 39,              /* instr_output  */
...
{
       0,   110,   110,   114,   115,   119,   120,   121,   125,   129,
     132,   138,   146,   150,   163,   168,   175,   180,   185,   190,
     197,   204,   205,   209,   216,   221,   228
};
#endif
...
{
  "\"end of file\"", "error", "\"invalid token\"", "MAIN", "PARD", "PARI",
  "ACD", "ACI", "SEMICOL", "FLOAT", "STRUCT", "COM", "EQ", "SCANF", "GH",
  "AND", "PRINTF", "INT", "PROCD", "ID", "CONST_INT", "PLUS", "MINUS",
  "MUL", "DIV", "NEWLINE", "$accept", "program", "bloc_instr", "instr",
  "instr_decl", "tip", "lista_var", "expr", "termen", "op_aritmetic",
  "instr_attr", "instr_io", "instr_input", "instr_output", "format", YY_NULLPTR
};
...
{
      -2,     9,    14,    10,   -19,    11,   -11,    12,    15,   -19,
       6,    13,    16,   -19,     2,   -19,   -19,   -19,   -19,     4,
     -18,   -16,   -19,   -11,    17,   -19,   -19,    18,    20,    19,
     -19,   -19,   -19,   -12,   -19,     2,     8,   -19,     7,   -19,
     -19,   -19,   -19,   -16,   -19,    21,    22,   -19,    26,   -19,
     -19
};
...
{
       0,     0,     0,     0,     1,     0,     0,     0,     0,     9,
       0,     0,     0,     5,     0,     6,     7,    21,    22,     0,
       0,     0,     2,     4,    10,     8,    26,     0,     0,     0,
      14,    15,    20,    12,     3,     0,     0,    25,     0,    16,
      17,    18,    19,     0,    11,     0,     0,    13,     0,    24,
      23
};
...
{
      26,     1,     7,    30,    31,     8,     9,    28,    10,    39,
      40,    41,    42,     3,     4,     5,    19,     6,    21,    20,
      22,    24,    26,    45,    23,    37,    46,    49,    35,    36,
      38,    50,    44,    47,     0,     0,     0,     0,     0,     0,
      48,     0,     0,     0,    29,     0,    34
};

static const yytype_int8 yycheck[] =
{
      18,     3,    13,    19,    20,    16,    17,    25,    19,    21,
      22,    23,    24,     4,     0,     5,     4,     6,    12,     4,
       7,    19,    18,    15,     8,     5,    19,     5,    11,    11,
      11,     5,    35,    43,    -1,    -1,    -1,    -1,    -1,    -1,
      19,    -1,    -1,    -1,    20,    -1,    23
};
...
{
       0,     3,    27,     4,     0,     5,     6,    13,    16,    17,
      19,    28,    29,    30,    31,    36,    37,    38,    39,     4,
       4,    12,     7,     8,    19,    32,    18,    40,    25,    40,
      19,    20,    33,    34,    28,    11,    11,     5,    11,    21,
      22,    23,    24,    35,    32,    15,    19,    34,    19,     5,
       5
};
...
#line 133 "analizor.y"
        {
            strcpy((yyval.varname), (yyvsp[0].varname));
			addToDeclarations((yyvsp[0].varname));
        }
#line 1195 "analizor.tab.c"
    break;

  case 11: /* lista_var: ID COM lista_var  */
#line 139 "analizor.y"
        {
            strcpy((yyval.varname), (yyvsp[-2].varname));
			addToDeclarations((yyvsp[-2].varname));
        }
#line 1204 "analizor.tab.c"
    break;
...
#line 1212 "analizor.tab.c"
    break;

  case 13: /* expr: termen op_aritmetic termen  */
#line 151 "analizor.y"
                {
			strcpy((yyval.varname), (yyvsp[-2].varname));
			strcat((yyval.varname), " ");

			strcat((yyval.varname), (yyvsp[-1].varname));
			strcat((yyval.varname), " ");

			strcat((yyval.varname), (yyvsp[0].varname));
		}
#line 1226 "analizor.tab.c"
    break;
...
#line 1234 "analizor.tab.c"
    break;

  case 15: /* termen: CONST_INT  */
#line 169 "analizor.y"
                {
			strcpy((yyval.varname), (yyvsp[0].varname));
		}
#line 1242 "analizor.tab.c"
    break;

  case 16: /* op_aritmetic: PLUS  */
#line 176 "analizor.y"
                {
			strcpy((yyval.varname), (yyvsp[0].varname));
		}
#line 1250 "analizor.tab.c"
    break;

  case 17: /* op_aritmetic: MINUS  */
#line 181 "analizor.y"
                {
			strcpy((yyval.varname), (yyvsp[0].varname));
		}
#line 1258 "analizor.tab.c"
    break;

  case 18: /* op_aritmetic: MUL  */
#line 186 "analizor.y"
                {
			strcpy((yyval.varname), (yyvsp[0].varname));
		}
#line 1266 "analizor.tab.c"
    break;

  case 19: /* op_aritmetic: DIV  */
#line 191 "analizor.y"
                {
			strcpy((yyval.varname), (yyvsp[0].varname));
		}
#line 1274 "analizor.tab.c"
    break;

  case 20: /* instr_attr: ID EQ expr  */
#line 198 "analizor.y"
                {
			addToAttrs((yyvsp[-2].varname), (yyvsp[0].varname));
		}
#line 1282 "analizor.tab.c"
    break;

  case 23: /* instr_input: SCANF PARD format COM AND ID PARI  */
#line 210 "analizor.y"
                {
			addScanf((yyvsp[-1].varname));
		}
#line 1290 "analizor.tab.c"
    break;

  case 24: /* instr_output: PRINTF PARD format COM ID PARI  */
#line 217 "analizor.y"
                {
			addPrintf((yyvsp[-1].varname));
		}
#line 1298 "analizor.tab.c"
    break;

  case 25: /* instr_output: PRINTF PARD NEWLINE PARI  */
#line 222 "analizor.y"
                {
			addPrintf("");
		}
#line 1306 "analizor.tab.c"
    break;


#line 1310 "analizor.tab.c"
